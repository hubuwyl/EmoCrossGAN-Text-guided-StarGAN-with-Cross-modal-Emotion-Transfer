...
def main(config):
    ...
    if config.dataset in ['RaFD', 'Both'] and config.mode == 'train':
        rafd_loader = get_loader(config.rafd_image_dir, None, None,
                                 config.rafd_crop_size, config.image_size, config.batch_size,
                                 'RaFD', config.mode, config.num_workers , config.ada)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ada', type=str2bool, default=False, help='whether to enable data augmentation')
    ...
    parser.add_argument('--rafd_image_dir', type=str, default='./RAFdb/train')
